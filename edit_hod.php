<?php 
		...
		if(isset($_POST['update'])){
			...
			$result1 = mysql_query("UPDATE hod_data SET firstname='".$_POST['firstname']."', lastname='".$_POST['lastname']."', email='".$_POST['email']."', dep_id='".$_POST['dep']."', contact='".$_POST['contact']."', gender='".$_POST['gender']."', date_modify='".date('Y-m-d')."' where id='".$id."'");
			if($result1){
				$_SESSION['pass'] = "Hod Profile Updated";	
			}
		}
            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="col-sm-6 hidden-xs">
                                ...
                                <h1>Edit HOD  Registration <!-- <small>overview & stats </small> --></h1>
                    </div>
                </div>
            </div>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										...
										<?php
											$result=mysql_query("select * from hod_data where id='".$id."'");
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" placeholder="Insert your First Name" class="form-control" id="firstname" name="firstname" maxlength="50" value="<?php echo $row['firstname'];?>">
													</div>
													<div class="form-group">
														<label class="control-label">
															Last Name <span class="symbol required"></span>
														</label>
														<input type="text" placeholder="Insert your Last Name" class="form-control" id="lastname" name="lastname" maxlength="50" value="<?php echo $row['lastname'];?>">
													</div>
													<div class="form-group">
														<label class="control-label">
													...
													<div class="form-group">
														...
														<input type="password" class="form-control" id="password_again" name="password_again" maxlength="50">
													</div>-->
												</div>
												<div class="col-md-6">
