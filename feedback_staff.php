            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="col-sm-6 hidden-xs">
                                ...
                                <h1>Staff  List <!-- <small>overview & stats </small> --></h1>
                    </div>
                </div>
            </div>
											   ...
											   ?>
												<tr>
													...
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="feedback.php?id=<?php echo $row['id'];?>" class="btn btn-xs btn-blue tooltips" data-placement="top" data-original-title="Give Feedback"><i class="fa fa-edit"></i></a>
													</div>
