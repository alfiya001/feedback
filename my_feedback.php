...
<html lang="en">
	...
	<!-- start: HEAD -->
	<head>
		<title>Feedback -My Feedback</title>
		<!-- start: META -->
		<meta charset="utf-8" />
            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="col-sm-6 hidden-xs">
                                ...
                                <h1>Student Feedback <small>Sem wise</small></h1>
                    </div>
                </div>
            </div>
        </div>
							...
							<div class="col-sm-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Your Feedback</h4>
										    ...
										    <?php 
											   $result = mysql_query("SELECT semster FROM staff_semester WHERE staff_id='".$row['id']."'");
												...
												while($row1 = mysql_fetch_assoc($result)){
													...
													$sum = mysql_fetch_array(mysql_query("SELECT count(id),sum(f1),sum(f2),sum(f3),sum(f4),sum(f5) FROM sem".$row1['semster']." WHERE staffid='".$row['id']."' AND status='1'"));
													                  if($sum[0] != 0){
												?>
