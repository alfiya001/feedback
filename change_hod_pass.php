<?php 
		...
		if(isset($_POST['submit'])){
			...
			$result1 = mysql_query("UPDATE hod_data SET password='".md5($_POST['password'])."', conpass='".$_POST['password_again']."', date_modify='".date('Y-m-d')."' where id='".$id."' ");
			if($result1){
            ...
            <div class="container-fluid">
                <div class="row">
                            <div class="col-sm-6 hidden-xs">
                                ...
                                <h1>Change HOD Password <!-- <small>overview & stats </small> --></h1>
                    </div>
                </div>
            </div>
