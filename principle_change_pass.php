<?php 
		...
		if(isset($_POST['submit'])){
			...
			$result1 = mysql_query("UPDATE hod_data SET pass='".md5($_POST['password'])."', conpass='".$_POST['password_again']."', date_modify='".date('Y-m-d')."' where id='".$id."' ");
			if($result1){
				$_SESSION['pass'] = "Hod Password Succsessfully Changed";	
			}
		}*/
						...
						<div class="toolbar row">
							<div class="col-sm-6 hidden-xs">
								<div class="page-header">
									<h1>Change Principle Password</h1>
								</div>
							</div>
						</div>
						<!-- end: TOOLBAR -->
										...
										<form action="" role="form" id="form" method="post">
											<div class="row">
												...
												<div class="col-md-6">
													...
													<?php 
														$res=mysql_query("select * from principle_data");
													...
													<div class="form-group">
														...
														<input type="password" class="form-control" name="password" id="password" maxlength="50" value="<?php echo $row2['conpass'];?>">
													</div>
													<div class="form-group">
														<label class="control-label">
															Confirm Password <span class="symbol required"></span>
														</label>
														<input type="password" class="form-control" id="password_again" name="password_again" maxlength="50" value="<?php echo $row2['conpass'];?>">
													</div>
												</div>
												<div class="col-md-6">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="form-group">
																...
																<input class="form-control" type="text" name="contact" id="contact" onKeyPress="return isNumberKey(event)" maxlength="12">
															</div>
														</div>
													</div>-->
